...
if st.session_state.page < q_count:
    ...
    result = {
        ...
        "INTJ": ("정우성", "img/result_intj.jpg", "계획적이고 분석적인 지휘자. 모든 상황을 계산하고 주도하는 전략가.", "산왕전 작전 지시 장면"),
