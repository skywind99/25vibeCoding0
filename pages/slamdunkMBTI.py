...
questions = [
    ...
    ("img/q2.png", "혼자 남은 체육관에서?", ["조용히 연습하며 집중", "사람들과 함께하고 싶음"], ["I", "S"], ["E", "F"]),
...
if st.button("결과 보기"):
    ...
    result = {
        ...
        "ISFJ": ("하루코", "img/result_isfj.jpg", "상냥하고 배려심 깊은 감성형. 주변을 챙기며 조용히 응원하는 스타일.", "“강백호 군… 멋져요!”"),
        ...
        "ISTP": ("미츠이 히사시", "img/result_istp.jpg", "위기에 강한 현실주의자. 침착하고 빠른 판단력, 단호한 행동력의 소유자.", "“미안하다, 나 아직 농구가 하고 싶어.”"),
        ...
        "INTP": ("관찰자형 감독", "img/result_intp.jpg", "감정보다 논리와 분석을 우선시하는 성향.", "조용히 경기를 지켜보는 장면"),
        ...
        "ESFJ": ("아야코", "img/result_esfj.jpg", "팀원 하나하나를 아끼고 돌보는 따뜻한 리더십의 조율자.", "“정대만! 그만해!!”"),
        "ENTJ": ("상양 감독", "img/result_entj.jpg", "목표 지향적이고 단호한 결정권자. 전략적으로 팀을 운용하는 리더.", "작전 타임 전체 장악 장면"),
    }
